...
function LoadingBarComponent_ng_container_0_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵstyleProp("width", ctx_r2.diameter)("height", ctx_r2.diameter);
  }
}
function LoadingBarComponent_ng_container_0_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const progress_r1 = ɵɵnextContext().ngIf;
    const ctx_r3 = ɵɵnextContext();
    ɵɵstyleProp("background", ctx_r3.color)("height", ctx_r3.height)("width", progress_r1 + "%");
  }
}
...
//# sourceMappingURL=chunk-3KJ7E7FA.js.map
